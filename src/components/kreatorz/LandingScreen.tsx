      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            entry.target.classList.add("animate-k-fade-up");
  ...
  return (
    <div className="min-h-screen pt-14">
      ...
      <section className="min-h-[calc(100vh-56px)] flex items-center px-8 py-16 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-[1]">
          <div className="lg:text-left text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 pl-2 border border-k-glow rounded-full text-[0.7rem] font-bold text-k-200 tracking-widest uppercase bg-k-glow mb-7 animate-k-fade-up">
              <span className="w-[7px] h-[7px] rounded-full bg-k-400 shadow-[0_0_8px] shadow-k-400 animate-k-pulse" />
              Creator Economy Platform
            </div>
            <h1 className="font-display text-[clamp(2.4rem,5.2vw,4.4rem)] font-normal leading-[1.06] tracking-tight text-primary-foreground mb-6 animate-k-fade-up" style={{ animationDelay: ".1s" }}>
              O link-in-bio que seus <em className="italic text-k-300">creators</em> merecem.
            </h1>
            <p className="text-[1.05rem] text-k-2 leading-relaxed max-w-[490px] mb-9 animate-k-fade-up lg:mx-0 mx-auto" style={{ animationDelay: ".2s" }}>
            ...
            <div className="flex gap-3.5 flex-wrap animate-k-fade-up lg:justify-start justify-center" style={{ animationDelay: ".3s" }}>
              <button className="inline-flex items-center gap-2 px-6 py-3.5 bg-primary text-primary-foreground font-semibold text-sm rounded-2xl transition-all duration-300 hover:bg-k-400 hover:shadow-k-purple hover:-translate-y-0.5 active:scale-[0.97]">
                Solicitar acesso
              ...
              <button className="inline-flex items-center gap-2 px-6 py-3.5 border border-k-glow text-k-2 font-medium text-sm rounded-2xl transition-all duration-300 hover:border-k-400 hover:text-primary-foreground hover:bg-k-glow hover:-translate-y-0.5">
                <svg width="15" height="15" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z" /></svg>
                Ver demo
              </button>
            </div>
            <div className="flex items-center gap-3.5 mt-9 animate-k-fade-up lg:justify-start justify-center" style={{ animationDelay: ".4s" }}>
          ...
          {/* PHONE MOCKUP */}
          <div className="flex justify-center animate-k-fade-up" style={{ animationDelay: ".5s", perspective: "1000px" }}>
      ...
      <section className="py-24 px-8 max-w-[1200px] mx-auto">
        <div className="inline-flex items-center gap-2 text-[0.66rem] font-bold text-k-300 tracking-[0.15em] uppercase mb-5">
          <span className="text-sm">⚡</span> O Problema
        </div>
        <h2 className="font-display text-[clamp(1.8rem,3.5vw,2.8rem)] font-normal leading-[1.1] tracking-tight text-primary-foreground max-w-[700px] mb-4">
          Links genéricos <em className="italic text-k-300">desvalorizam</em> seus creators.
        </h2>
        <p className="text-base text-k-2 leading-relaxed max-w-[540px] mb-14">
      ...
      <section className="text-center py-28 px-8 relative">
        ...
        <div className="relative z-[1]">
          <h2 className="font-display text-[clamp(1.8rem,3.5vw,2.8rem)] font-normal leading-[1.1] tracking-tight text-primary-foreground max-w-[620px] mx-auto mb-4">
            Pronto para criar páginas que <em className="italic text-k-300">impressionam</em>?
          </h2>
          <p className="text-base text-k-2 leading-relaxed max-w-[440px] mx-auto mb-8">
